...
import com.reactlibrary.models.HttpRequest;
import com.reactlibrary.models.HttpResponse;
import com.reactlibrary.utils.HttpUtil;
import com.reactlibrary.utils.JsonUtil;
...
public class HttpModuleModule extends ReactContextBaseJavaModule {
    ...
    public HttpModuleModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void fetch(String stringArgument, int numberArgument, Callback callback) {
